...
if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["prescription"])) {
    ...
    if (empty($prescription)) {
        ...
        $sql = "INSERT INTO `prescription`(`patient_id`, `Doctor_id`, `text`, `date`) VALUES ({$patient_id},{$_SESSION['id']},'{$prescription}','{$today}')";
    ...
    header("Location: doctorAppointment.php?error=something wrong");
	    exit();
}
